 ...
 * 목업 한적도 공급자.
 *
 * <p>장소별 기준값에 요일 보정만 얹은 아주 단순한 규칙이다.
 * 요일 보정을 넣은 이유는 "더 한적한 날짜 안내" 기능을 실제 예측 데이터 없이도 화면에서 확인하기 위해서다.
 * <b>보정폭은 근거 있는 수치가 아니라 화면 확인용 임시값이다.</b>
 */
@Component
@Profile("mock")
public class MockQuietnessProvider implements QuietnessProvider {
