          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex min-w-0 flex-col gap-1">
              {/*
                ...
                ⚠️ 한때 "PLACE OFF · 다른 곳 둘러보기"였다. <b>내부 이름을 화면에서 걷어냈다</b>
                (2026-08-29) — 사용자가 알아야 하는 것은 무엇을 할 수 있는가이지 우리가 그
                기능을 뭐라 부르는가가 아니다. UI 글자는 한국어 동사로 간다.

                ⚠️ 이 말은 시트를 <b>연 버튼과 같아야 한다</b>("다른 곳 둘러보기").
                버튼과 머리글이 다른 말을 하면 같은 기능이 둘로 보인다.
              */}
              <span className="text-hint text-[12.5px]">다른 곳 둘러보기</span>
              {/*
