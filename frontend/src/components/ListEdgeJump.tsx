 ...
 *
 * <p>대신 <b>목록의 위아래 끝에 한 줄씩</b> 둔다. 목록 끝에 닿았을 때 바로 그 자리에
 * 버튼이 있으므로, 떠 있는 버튼이 하던 일을 그대로 하면서 화면을 가리지 않는다.
 *
  ...
  return (
    <div className="flex justify-center">
      <button
        type="button"
        onClick={jump}
        className="press text-muted hover:text-brand-deep hover:bg-bg rounded-chip flex cursor-pointer items-center gap-1.5 bg-transparent px-3 py-2 text-[12.5px] font-semibold transition-colors"
      >
