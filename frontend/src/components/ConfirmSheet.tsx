...
export function ConfirmSheet({
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col justify-end lg:items-center lg:justify-center lg:p-8">
      ...
      <div
        className="bg-bg relative w-full rounded-t-[26px] shadow-[0_-10px_40px_rgb(22_33_31/0.24)] lg:max-w-[400px] lg:rounded-[24px] lg:shadow-[0_24px_60px_rgb(22_33_31/0.28)]"
        role="alertdialog"
        aria-modal="true"
        ...
        <div className="mx-auto flex w-full max-w-form flex-col gap-4.5 px-5.5 pt-5 pb-6">
          ...
          <div className="flex flex-col gap-2.25">
            ...
            <button
              ...
              onClick={onCancel}
              disabled={busy}
              className="border-line bg-surface text-fg hover:bg-bg rounded-ui h-13 cursor-pointer border text-[15.5px] font-semibold transition-colors disabled:cursor-not-allowed disabled:text-hint"
            >
              {cancelLabel}
            </button>
          </div>
