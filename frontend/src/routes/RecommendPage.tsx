  ...
  return (
    <div className="mx-auto flex w-full max-w-read flex-col gap-3.5 pb-10">
      {/*
        ...
        ("취향은 챙기고, 붐빔은 살짝 비켜간"). <b>한 줄만 남기지 말 것.</b>
        첫 줄만 남으면 뽑기가 되고, 둘째 줄만 남으면 매번 달라지는 이유가 사라진다.

        <p>여기 "오늘"은 <b>여행 날짜가 아니라 뽑은 시점</b>이다. 여행 날짜는 바로 아래
        카드가 따로 적는다. ⚠️ 그래서 <b>홈에는 이 말을 쓰지 않는다</b> — 그쪽에는 진짜
        "오늘의 경주"(오늘의 혼잡)가 있어 같은 말이 두 뜻으로 쓰이게 된다.
