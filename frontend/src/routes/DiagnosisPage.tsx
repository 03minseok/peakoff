          ...
          >
            {/*
              ■ 두 회피 경로가 같은 문형으로 선다 (TIME OFF · PLACE OFF)
                ...
                곳  다른 곳 발견하기   — 계획은 그대로, 더 여유로운 여행지를 찾아드려요
                        ...
                        */}
                        ...
                        {quietness === null || level === null ? (
                          /*
                            ...
                            문구가 "다른 곳 발견하기"가 아니라 "가까운 곳"인 이유: 열리는 것이
                          ...
                          */
                          <button
                            ...
                            /*
                              "바꾸기"가 아니라 "발견하기"다. 바꾸라는 말은 지금 고른 곳이
                              틀렸다는 지적으로 읽힌다 — 사용자가 직접 짠 코스에 대고
                              시스템이 무르라고 하는 셈이다. 우리가 하는 일은 <b>더 나은
                              선택지를 찾아 주는 것</b>이고, 고르는 판단은 여전히 사용자 몫이다.
                            */
                            aria-label={`${slot.place.name} 대신 갈 만한 다른 곳 발견하기`}
                          >
                            다른 곳 발견하기
                          </button>
                        )}
