            ...
            <span className="relative flex flex-col gap-3">
              ...
              */}
              ...
              {/*
                ...
                ⚠️ <b>여기서는 "오늘의"를 붙이지 않는다.</b> 설문 화면 쪽 버튼은
                "오늘의 여행 발견하기"인데, 홈만 다른 데는 두 가지 이유가 있다.

                하나, 이 제목은 옆 카드("코스 짜기")와 <b>짝</b>이다. 한쪽만 길어지면
                나란히 선 두 문의 무게가 갈린다.

                둘, <b>이 화면에는 진짜 "오늘"이 따로 있다</b> — 아래 "오늘의 경주"는
                오늘의 혼잡을 말한다. 같은 화면에서 같은 말이 두 뜻으로 쓰이면 어느 쪽도
                믿기 어려워진다. 설문 화면에는 그 충돌이 없다.
              */}
