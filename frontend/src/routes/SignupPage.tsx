...
export function SignupPage() {
  ...
  return (
    <AuthShell
      ...
      /*
        ⚠️ <b>"맞대어"를 뺐다</b> (2026-09-09). 코스 둘을 나란히 놓고 견주던 겹창은
        2026-09-01에 걷어냈다({@code CourseDetailOverlay} 주석). 지금 남은 것은 마이페이지
        목록에 카드가 늘어서고 카드마다 한적 지수가 적히는 것까지다 —
        <b>"나란히 볼 수 있다"까지는 참이고 "맞대어 본다"는 없는 기능을 가리킨다.</b>

        계산하지 않은 것을 근거로 말하지 않는다는 규칙과 같은 자리다. 기능이 사라질 때
        그것을 약속한 문구도 함께 찾아야 한다.
      */
      panelDescription="가입하면 완성한 코스를 저장해두고, 다음에 짠 코스와 한적 지수를 나란히 볼 수 있어요."
      footer={
